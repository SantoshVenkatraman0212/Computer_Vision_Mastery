'''
This file demonstrates Non-Maximal Suppression  
'''
# Importing necessary libraries
import numpy as np
from config.paths import sample_img_path, nms_demo_img_path
...
plt.savefig(f'{nms_demo_img_path}/nms_demo.png', dpi = 300, bbox_inches = 'tight')